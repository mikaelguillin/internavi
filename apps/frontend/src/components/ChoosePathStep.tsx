  ...
  const paths = [
    {
      ...
      description:
        "Browse our comprehensive database of schools and filter by your preferences",
      icon: "🔍",
    ...
    <section className="max-w-6xl mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground">
          {studyLevel
            ? `Great choice! You selected ${studyLevel.replace(
                "-",
                " "
          ...
          <Button
            ...
            onClick={() => {
              if (selectedPath === "explore") {
                ...
                // Store path choice and redirect to quiz
                sessionStorage.setItem("chosenPath", selectedPath);
